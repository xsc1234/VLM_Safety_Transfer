    ...
    def greedy_search(
        ...
        **model_kwargs,
        ...
        while True:
            ...
            if add_text_ids is None and cut_flow_layers is None and repeat_layers is None:
                outputs = self(
                    **model_inputs,
                    return_dict=True,
                    output_attentions=output_attentions,
            ...
            elif add_text_ids is not None and image_shape is not None and cut_flow_layers is None and repeat_layers is None:
                outputs = self(
                    **model_inputs,
                    return_dict=True,
                    output_attentions=output_attentions,
            ...
            elif add_text_ids is not None and image_shape is None and cut_flow_layers is None and repeat_layers is None:
                outputs = self(
                    **model_inputs,
                    return_dict=True,
                    output_attentions=output_attentions,
            ...
            elif add_text_ids is None and cut_flow_layers is not None and repeat_layers is None:
                outputs = self(
                    **model_inputs,
                    return_dict=True,
                    output_attentions=output_attentions,
            ...
            elif add_text_ids is None and cut_flow_layers is None and repeat_layers is not None:
                outputs = self(
                    **model_inputs,
                    return_dict=True,
                    output_attentions=output_attentions,
            ...
            #print('next tokens is {}'.format(next_tokens))
            # finished sentences should have their next token be a padding token
            if eos_token_id is not None:
                if pad_token_id is None:
                    raise ValueError("If `eos_token_id` is defined, make sure that `pad_token_id` is defined.")
