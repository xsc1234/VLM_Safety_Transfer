...
if __name__ == '__main__':
    ...
    with open(training_args.read_json, 'r') as f1:
        for line in f1:
            ...
            prompt = '''Describe this scene : {}'''.format(text)
            qs = prompt
            ...
            if len(data_list) % 100 == 0:
                joblib.dump(data_list, training_args.output_path+'analysis_data_llava_v1-6_mistral_vlm_no_image')
